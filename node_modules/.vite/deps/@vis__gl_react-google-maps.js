...
var GoogleMapsApiLoader = class {
	...
	static load(params, onLoadingStatusChange) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if ((_b = (_a = window.google) === null || _a === void 0 ? void 0 : _a.maps) === null || _b === void 0 ? void 0 : _b.importLibrary) {
				if (!this.serializedApiParams) this.loadingStatus = APILoadingStatus.LOADED;
				this.notifyLoadingStatusListeners();
			} else {
				this.serializedApiParams = serializedParams;
				this.initImportLibrary(params);
			}
			if (this.serializedApiParams && this.serializedApiParams !== serializedParams) console.warn("[google-maps-api-loader] The maps API has already been loaded with different parameters and will not be loaded again. Refresh the page for new values to have effect.");
	...
	static initImportLibrary(params) {
		...
		const loadApi = () => {
			...
			apiPromise = new Promise((resolve, reject) => {
				...
				scriptElement.src = `https://maps.googleapis.com/maps/api/js?` + urlParams.toString();
				scriptElement.nonce = ((_a = document.querySelector("script[nonce]")) === null || _a === void 0 ? void 0 : _a.nonce) || "";
				scriptElement.onerror = () => {
					this.loadingStatus = APILoadingStatus.FAILED;
					this.notifyLoadingStatusListeners();
					reject(/* @__PURE__ */ new Error("The Google Maps JavaScript API could not load."));
				};
	...
	*/
	static notifyLoadingStatusListeners() {
		for (const fn of this.listeners) fn(this.loadingStatus);
	}
};
/**
...
function useGoogleMapsApiLoader(props) {
	...
	const serializedParams = (0, import_react.useMemo)(() => JSON.stringify(Object.assign({
		apiKey,
		version
	}, otherApiParams)), [
		apiKey,
	...
	const importLibrary = (0, import_react.useCallback)((name) => __awaiter(this, void 0, void 0, function* () {
		...
		if (!((_a = google === null || google === void 0 ? void 0 : google.maps) === null || _a === void 0 ? void 0 : _a.importLibrary)) throw new Error("[api-provider-internal] importLibrary was called before google.maps.importLibrary was defined.");
	...
	(0, import_react.useEffect)(() => {
		__awaiter(this, void 0, void 0, function* () {
			try {
				...
				else console.error("<ApiProvider> failed to load the Google Maps JavaScript API", error);
			}
		});
	}, [
		apiKey,
...
function useMemoized(value, isEqual) {
	...
	return (0, import_react.useMemo)(() => {
		if (previous && isEqual(previous, value)) return previous;
		return value;
	}, [
		value,
		previous,
...
function useMapInstance(props, context) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (savedMapStateRef.current) {
			...
			if (savedMapId !== mapId) map.setOptions(savedCameraState);
		}
		return () => {
...
var Pin = (props) => {
	...
	(0, import_react.useEffect)(() => {
		var _a;
		if (!advancedMarker) {
			if (advancedMarker === void 0) console.error("The <Pin> component can only be used inside <AdvancedMarker>.");
			return;
		}
